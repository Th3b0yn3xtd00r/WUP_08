...
We are going to compute regression models finding one regression model that does the best job in predicting the bear length and its correspondence to the bears neck size, age, head width, head length, and WEIGHT
...
The adjusted r squared for WEIGHT is 0.7869.
